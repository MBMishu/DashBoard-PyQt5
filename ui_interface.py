...
"")
        ...
        self.percentageBtn = QPushButton(self.frame_4)
        self.percentageBtn.setObjectName(u"percentageBtn")
        icon = QIcon()
        icon.addFile(u":/icons/Qss/icons/bar-chart-2.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.percentageBtn.setIcon(icon)
        self.percentageBtn.setIconSize(QSize(24, 24))

        self.verticalLayout_2.addWidget(self.percentageBtn)

        self.tempBtn = QPushButton(self.frame_4)
        self.tempBtn.setObjectName(u"tempBtn")
        icon1 = QIcon()
        icon1.addFile(u":/icons/Qss/icons/thermometer.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.tempBtn.setIcon(icon1)
        self.tempBtn.setIconSize(QSize(24, 24))

        self.verticalLayout_2.addWidget(self.tempBtn)

        self.nestedBtn = QPushButton(self.frame_4)
        self.nestedBtn.setObjectName(u"nestedBtn")
        icon2 = QIcon()
        icon2.addFile(u":/icons/Qss/icons/target.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.nestedBtn.setIcon(icon2)
        self.nestedBtn.setIconSize(QSize(24, 24))

        self.verticalLayout_2.addWidget(self.nestedBtn)

        self.lineBtn = QPushButton(self.frame_4)
        self.lineBtn.setObjectName(u"lineBtn")
        icon3 = QIcon()
        icon3.addFile(u":/icons/Qss/icons/trending-down.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.lineBtn.setIcon(icon3)
        self.lineBtn.setIconSize(QSize(24, 24))

        self.verticalLayout_2.addWidget(self.lineBtn)

        self.barBtn = QPushButton(self.frame_4)
        self.barBtn.setObjectName(u"barBtn")
        icon4 = QIcon()
        icon4.addFile(u":/icons/Qss/icons/bar-chart.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.barBtn.setIcon(icon4)
        self.barBtn.setIconSize(QSize(24, 24))

        self.verticalLayout_2.addWidget(self.barBtn)
        ...
        self.label_15.setPixmap(QPixmap(u":/icons/Qss/icons/settings.svg"))
        ...
        self.label_17.setPixmap(QPixmap(u":/icons/Qss/icons/search.svg"))
        ...
        self.label_16.setPixmap(QPixmap(u":/icons/Qss/icons/info.svg"))
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/Qss/icons/align-center.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.minimize_window_button = QPushButton(self.frame_10)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/Qss/icons/minus.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.restore_window_button = QPushButton(self.frame_10)
        self.restore_window_button.setObjectName(u"restore_window_button")
        self.restore_window_button.setMinimumSize(QSize(30, 30))
        self.restore_window_button.setMaximumSize(QSize(30, 30))
        self.restore_window_button.setCursor(QCursor(Qt.ArrowCursor))
        icon7 = QIcon()
        icon7.addFile(u":/icons/maximize-2.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.close_window_button = QPushButton(self.frame_10)
        self.close_window_button.setObjectName(u"close_window_button")
        self.close_window_button.setMinimumSize(QSize(30, 30))
        self.close_window_button.setMaximumSize(QSize(30, 30))
        icon8 = QIcon()
        icon8.addFile(u":/icons/Qss/icons/x.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.stackedWidget = QCustomQStackedWidget(self.frame_7)
        ...
        self.frame_12 = QFrame(self.footer_frame)
        ...
        self.size_grip.setCursor(QCursor(Qt.SizeAllCursor))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.percentageBtn.setText(QCoreApplication.translate("MainWindow", u"Percentage Chart", None))
        self.tempBtn.setText(QCoreApplication.translate("MainWindow", u"Teamparature Chart", None))
        self.nestedBtn.setText(QCoreApplication.translate("MainWindow", u"Nested Donuts", None))
        self.lineBtn.setText(QCoreApplication.translate("MainWindow", u"Line Chart", None))
        self.barBtn.setText(QCoreApplication.translate("MainWindow", u"Bar Chart", None))
